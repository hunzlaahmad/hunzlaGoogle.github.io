...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subs.push(this.movie.getNowPlaying().subscribe(function (data) {
            return _this.nowPlaying = data;
          }));
          this.subs.push(this.movie.getTrending().subscribe(function (data) {
            _this.trending = data;
            _this.headerBGurl = 'https://image.tmdb.org/t/p/original/' + _this.trending.results[2].backdrop_path;
          }));
          this.subs.push(this.movie.getTopRated().subscribe(function (data) {
            return _this.topRated = data;
          }));
          this.subs.push(this.movie.getPopular().subscribe(function (data) {
            return _this.popular = data;
          }));
          this.subs.push(this.movie.getNowPlaying().subscribe(function (data) {
            return _this.nowPlaying = data;
          }));
          this.subs.push(this.movie.getOriginals().subscribe(function (data) {
            return _this.originals = data;
          }));
        }
      }, {
        key: "ngOnDestroy",
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_movie_service__WEBPACK_IMPORTED_MODULE_1__["MovieService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 59,
      vars: 15,
      consts: [[1, "container"], [1, "header"], [1, "header-banner", 3, "ngStyle"], [1, "header-buttons"], [1, "play-button"], [1, "more-button"], ["id", "stickyheader", 1, "header-main"], ["stickheader", ""], [1, "header-left"], ["routerLink", "/"], ["src", "assets/netflix.svg", "alt", "logo"], [1, "active"], ["href", "#"], [1, "header-right"], ["src", "assets/ava.png", "alt", "avatar"], [1, "body", 2, "margin-top", "30rem"], ["title", "Trending", 3, "movies", "sliderConfig"], ["title", "Top Rated", 3, "movies", "sliderConfig"], ["title", "Originals", 3, "movies", "sliderConfig"], ["title", "Now Playing", 3, "movies", "sliderConfig"], ["title", "Popular", 3, "movies", "sliderConfig"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgStyle"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_3__["MatIcon"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterLinkWithHref"], _components_slider_slider_component__WEBPACK_IMPORTED_MODULE_5__["SliderComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_7__["SlickCarouselModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_slider_slider_component__WEBPACK_IMPORTED_MODULE_5__["SliderComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_7__["SlickCarouselModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]],
        exports: [_angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppComponentsSliderSliderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SliderComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
    ...
    SliderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 3,
      consts: [[1, "movie"], [1, "movie-images"], [1, "thumbnails"], [1, "carousel", 3, "config"], ["class", "slick-item", "ngxSlickItem", "", 4, "ngFor", "ngForOf"], ["ngxSlickItem", "", 1, "slick-item"], [3, "src", "alt"]],
      ...
      directives: [ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_1__["SlickCarouselComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], ngx_slick_carousel__WEBPACK_IMPORTED_MODULE_1__["SlickItemDirective"]],
  ...
  function srcAppServicesMovieServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MovieService = /*#__PURE__*/function () {
      ...
      _createClass(MovieService, [{
        key: "getTrending",
        value: function getTrending() {
          return this.http.get("".concat(this.URL, "/trending/all/week"
          /* trending */
          ), {
            params: {
        ...
        value: function getTopRated() {
          return this.http.get("".concat(this.URL, "/movie/top_rated"
          /* top_rated */
          ), {
            params: {
              api_key: this.api_key
        ...
        value: function getPopular() {
          return this.http.get("".concat(this.URL, "/movie/popular"
          /* popular */
          ), {
            params: {
              api_key: this.api_key
        ...
        key: "getOriginals",
        value: function getOriginals() {
          return this.http.get("".concat(this.URL, "/discover/tv"
          /* originals */
          ), {
            params: {
              api_key: this.api_key
        ...
        value: function getNowPlaying() {
          return this.http.get("".concat(this.URL, "/movie/now_playing"
          /* now_playing */
          ), {
            params: {
              api_key: this.api_key
    ...
    MovieService.ɵfac = function MovieService_Factory(t) {
      return new (t || MovieService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](MovieService, [{
